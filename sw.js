...
const SW_VERSION = 'admin-v10';
const CACHE = 'asrar-admin-' + SW_VERSION;
const SHELL = ['/', '/index.html', '/admin.css',
  '/admin-core.js', '/admin-dashboard.js', '/admin-content.js', '/admin-planner.js', '/admin-market.js', '/admin-users.js', '/admin-fonts.js', '/admin-referral.js', '/admin-stats.js',
